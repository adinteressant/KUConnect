...
const WelcomeModal = ({ email, username, onClose }) => {
  return (
      ...
      <div className="bg-white rounded-lg p-8 max-w-md w-full mx-4 relative">
        ...
        <div className="flex flex-col items-center space-y-4">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-4">You are now connected with the username: 
            <h3 className="text-xl font-semibold mb-4">{username}!</h3>
            usingg the email: <p className="text-gray-600 mb-4">{email}
                </p>
                </p>
          </div>
