                ...
                <div className='flex items-center gap-4 ml-2 mt-1 text-gray-600 text-xs'>
                  ...
                  {comment.likes > 0 &&
                    <button
                      ...
                      onClick={() => setShowCommentLikes(() => true)}
                    >
                      Likes: {comment.likes}
                    </button>
                  }
          ...
          {showCommentLikes &&
            createPortal(
              <div
                ...
                `}
                onClick={() => setShowCommentLikes(() => false)}
              >
                <div 
                ...
                >
                  <button
                    onClick={() => setShowCommentLikes(() => false)}
                    className='absolute top-2 right-2 p-2 rounded-full dark:hover:bg-gray-700 hover:bg-gray-200'
                  >
                  ...
                  <ShowLikes parent={'comment'} commentId={comment.commentId} />
                </div>
              </div>,
              document.body
            )
